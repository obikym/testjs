...
var client = { phone: "", name: "", payment: "", share: "", pure: "" };
...
bot.on("callback_query", (callbackQuery) => {
  ...
  client.pure = client.payment / 100 * Number(client.share)
  bot.sendMessage(callbackQuery.message.chat.id, "Вы заработали - " + client.pure + "р");
})
